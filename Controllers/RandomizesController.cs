...
namespace Danger.Controllers
{
    public class RandomizesController : Controller
    {
        ...
        public async Task<IActionResult> SearchResult(String Searching)
        {
            return View("Index",await _context.Randomize.Where(s=>s.Comments.Contains(Searching) || s.UserTag.Contains(Searching)).ToListAsync());
        }
